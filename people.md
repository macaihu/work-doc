...
张悦玲
  ...
  2009-4-20 买电热洗脚盆。
  2009-4-10 早上去给娃报名去了。
  2009-4-9 将移植到龙尚平台的话机程序开始狂改，说让苗立双改将电话簿和分组分成两个文件，结果就是不改。
...
梁剑
  ...
  2017.9.12 使用pppoe的情况下, echo c > ... 发起l2tp连接后, 需要1分钟后才能连接, 而使用4g的情况就很快就回了.如果是4g切换到pppoe的情况, 那么要到6-7分钟后才正常. 直接使用pppoe, 要2-3分钟才能使用.检查默认路由的方式应该改为链路检查的方式.使用一段时间后拔掉网线, 4g不能得到ip, 4-5分钟才能恢复(一次).当使用了一段时间工业路由器后, 把网线拔到原来用的tplink上后, tplink无法拨上pppoe, 重启后可以拨上了.
  ...
  2008-8-29 再次出了一个版本，但是不幸的是还要改程序。
...
张勇
  ...
  2016.9.12 工业路由器：张勇想把拨号程序和脚本进行简化，加上data区，改为squash文件系统，配置文件放在data区，web保存命令简化。其中“加上data区，改为squash文件系统 ”已经完成。
  2015.4.20 面试。
...
张伟
  ...
  2008-3-8 发现线发多了。
  2008-3-5 早上离开，去北京三号候机楼拍照片去了。
  2008-3-4 一早来到了宾馆，去换了打印机和支架，下午和万辉一起在移动营业厅。认为170的宾馆很贵。
  2008-3-3 发来的机器没有换黑标检测位置，今天动身到北京，再来石家庄。由于我左一个电话又一个电话，后来打电话问我还要带什么来。晚上12：30的火车，到石家庄要到4点，说没关系，习惯了。
  2008-3-1 查到色带今天已经到了。
  2008-2-29 说新的机器要到3.7才能到公司。识币器要2-3天后到。
  2008-2-28 说色带已经寄出。
  2008-2-27 找来了打印机厂家的人来询问黑标判断位置。

叶传维
  2009-4-13 通则的司机。今天拉了我们去吉翁，回去的时候顺带去把手机带给一个人修。颜斌问他就这样把手机给别人，他说，说客家话的，没事。

徐红青
  2009-4-13 吉翁工程开发部经理。今天跑来说，软件的事情他们不能提供支持。从他的语气来说，不是不行，而是不能。因为没给钱。

李启辉
  2008-3-28 问是否有查询终端。

张国涛
  2009-4-9应该和高姐是夫妻？做发货工作，贴出了对他的表扬。

肖志威
  2009-3-19 打球的时候比较喜欢笑。
  2009-3-18 打乒乓球有“自杀”的美誉。发球较快，但成功率有问题。

高姐
  2009-4-9 通则公司打扫卫生。和高友华应该是亲戚。在说楼下都在将自己的亲戚拉入公司。

高友华
  2009-4-9 彭广才的老婆。早上对于占道的车很气愤，说没有功德。

韩冰
  2009-4-9 通则公司物控部的，应该在公司很久了。看见我热饭，问“吃夜宵？”

黄书玲
  2009-4-8 居然在淘宝上开了一个服装店。
  2008-4-24 专门上来催3g模块的事情，穿得比较少一点。说安玉民的客户可能无法拿到公司的订单，因为她的客户要拍它权，让公司只给他供货。

Maka
  2009-4-8 来信说那个指示呼叫转移进来的at指令有效。
  2008-11-25 又来一份信重申“运营商名称在选择菜单中就要修改”
  2008-11-24 回信说运营商名称在选择菜单中就要修改。
  2008-11-18 来信问到两个问题：1、是否能从sim卡中读到运营商名称2、为何在手柄上录音只有单路
  2008-11-6 正在休假。
  2008-3-13 要了一个不要休眠的版本去。
  2008-2-22 同意使用增大声音的版本出货。

方舒
  2008-3-19 今天终于回来了。在河北呆了很久
  2008-12-3 应该基本写完了四川的程序。在成都。
  2008-11-21 四川的程序写了动态库接口部分。
  2008-11-18 让他改程序，dblog不应该调用webserver中的变量，到是很快就修改了。
  2008-11-3 在写写卡操作部分的程序。
  2008-8-22 把PIN当作MODEM的一部分。
  2008-8-21 机器貌似中招了，merge一运行就自动跳出了。  重装更惨，直接启动不了了，疑似联想锁定了硬盘。
  2008-8-4 似乎仍然无法理解回调函数。说那个智能卡忽然不能用了。
  2008-8-1 基本完成了智能卡阅读器的接口，以为和身份证读卡器一样需要使用回调的方法。
  2008-7-29 曾经想让我给同学写实习的鉴定，被我拒绝。写程序似乎一般，但还是能做出些东西来。

邱顺辉
  2009-3-19 说他也申请了经济适用房，难道他没有买房子？
  
王亿
  2009-3-19 美工。 今天的球是她买的，也比较喜欢打乒乓球。

张瑜
  2009-3-17 行政部的。说经济适用房有张帆、李志江、张伟和我报名。

贾延峰
  2008-5-18 沧州移动的。每次都强调使用“二维码”。

沈阳
  2008-2-19 现在南昌微软技术中心工作，据熊伟说擅长项目管理，哥哥是江西信息产业厅副厅长。

陈国栋
  2008-2-29 和通则公司的人是老朋友了，在我这里主要做了重庆的IP超市。

李伟(石家庄移动)
  2008-3-2 发现azz216这个
  2008-3-1 打电话问他终端的IP，他说找个空的就好，而且很快的挂了电话，似乎有事情在忙。
  2008-2-26 感觉他以为我们终端已经放好。
  2008-2-25 主动帮我们连网线等。
  
张民利
  2008-3-2 浙江华隆公司，貌似项目经理，工作负责，而且似乎很正规。

熊伟
  2009-3-17 独立开了公司，做了一下公安局的程序，网上抓逃犯之类的。年营业额能到10几万。
  2008-11-21 上次打电话的时候正在和交通厅的人做系统。
  2008-4-26 现在在南昌给建材批发商做管理软件。
  2008-3-25 由于沈阳改变注意，所以美国的公司取消了合作。同时他已经辞职，只有回去开公司了。
  2008-2-27 说美国人主要看重的是C#的编程能力。说这个公司的另外一个合伙人也有到江西开公司的意思。
  2008-2-26 5:30的时候发来短消息，我没有时间，后来发短消息来说明天联系。
  2008-2-25 对我不能到上海很遗憾，说路还找了一个人。
  2008-2-24 再次询问是否能到上海。
  2008-2-22 中午发消息来询问是否能到上海。
  2008-2-20 打电话来说下周二到上海面试，并说如果我不参加他没有信心。
  2008-2-19 似乎不再那么在乎电话费了。

瞿海波
  2008-3-2 比较黑，有的胖。中午看恶搞斯巴达300勇士的电影。

李涵
  2008-8-21 周六的时候她老爸带她来，吃了饭，希望能照顾。在老爸面前非常少说话。周一上了一天班，又消失了。
  2008-5-15 无法承受地震的事实，现已经请假。和我谈起她的几个男友。
  2008-5-6 买了蛋挞给大家吃。
  2008-2-24 今天父母回去，在花好园买了房子，全部算起来每平米13000元。

梁某(石家庄移动)
  2008-8-22 对我们的到来无动于衷。
  2008-3-5 取钱对账发现多了10元，还给了我们。
  2008-3-4 说没有统计信息也没有关系，收费终端可以照样用。
  2008-3-2 应该是副班长，对电脑懂得比较少，帮我PING出了空的IP地址。看了一下如何操作机器。营业厅是“石家庄中山西路第二营业厅”。
  2008-3-1 移动公司某个营业厅大堂，不是班长。说主要问题是识币器有些钱不认，而且往往越新的钱越不认。月初的时候，交钱速度慢。有时候要帮大客户交钱，也要使用自助终端。

贺思炜
  2008-8-29 在qq群中小喻说他的程序改了以后要全测，很不好。告诉他要自己多测试一些。
  2008-8-6 我面试进来，无项目经验。曾经有一个周日，打电话问了短消息的修改问题。

赵某(女,石家庄移动)
  2008-8-30 前几天不解的问我们：你们的程序很好了，为什么还要天天改？
  2008-3-6 说姓名中的“90天内注销收费30元”等要保留 认为我们的识币器速度快。
  2008-3-2 石家庄中山西路第二营业厅班长。对我们的设备充满期待。

路向民
  2018.11.9 单总提到，反馈说河北那里由于我们的话机交货时间长，已经从其他厂商采购。
  2008-11-3 催着去和华为的调协议。
  2008-9-24 打电话说那个写卡的事情，还是只有盯住李婧，让她去找大唐的人才行。
  2008-9-10 打电话说了几件事情，主要说那个自动扫描的问题。
  2008-9-2 说华为的营业额大增，认为在华为比较舒服。
  2008-8-30 6月的时候到沧州和他住在一起，还去了一次游泳。6月去北京招标，他也在场。继续催着华为给写卡的协议出来。
  2008-3-6 虽然有些不情愿，但还是让我走了。
  2008-3-4 上午给他交钱发现余额又有问题，让我交了好几次，下午把钱通过万辉转给我。下午带办事处的徐某到了营业厅。明天去沧州谈。
  2008-3-3 对于进度有些不满，并要求张伟今天就从北京赶来。
  2008-3-2 对发票中多出来的8.71元耿耿于怀，生怕是我们的终端搞出来的问题。
  2008-3-1 一起去了苑东路的营业厅。住在石家庄水上乐园那里。
  2008-2-28 询问了一下我们住在了哪里，说识币器和打印机质量要加强。
  2008-2-27 中午请我们吃驴肉火烧。赶着四处招标。
  2008-2-26 对收费终端很不满意。不想把机器搬到现场。
  2008-2-25 听说驿家客满，另外找了个加速8的连锁店，而且明天也没有房间了。联系好了，把服务器搬进了机房。但大柜子在那里还没有联系好，似乎有些困难。
  2008-2-23 似乎还没有完全安排好和石家庄联调的样子。
  2008-2-20 向提出要发票打印试验，很为难的样子。

吴建国
  2008-11-18 在qq里对我说想回来。
  2008-5-22 昨天辞职，主要是觉得胡仲其对他有敌意。
  2008-3-17 和万辉一起装好了raid。
  2008-3-14 叹息说做网页眼睛很累。
  2008-3-13 晚上和我和王五一起往会走，一般也不说话。和万辉住在单间的房子里，有厨房，但很小。站两个人就满了。
  2008-3-2 做了程序，做的时候胡仲其没有说什么，做完了却要改，不乐意了，说为什么做的时候不说？
  2008-2-24 在咸阳机场听到登机呼叫才往里走，差点没有赶上。

付智勇
  2008-11-24 告诉他ocx上线的事情，似乎心不在焉。 可能升级的很恼火了。
  2008-8-21 前两天打电话来问，新定了缴费终端，是否需要研发派人来安装。
  2008-7-25 给他打电话说3c只有下周才有。还对我说了谢谢，主要指让梁剑过去解决问题。
  2008-7-24 应该是见过两次了。上一次还是去年去谈终端写卡方案的时候。这一次是去谈收费终端的接口。曾经在南昌住过好几年，下次去要带上皇上皇的鸭子去。

毛茂兴
  2008-11-24 似乎参加了周六公司组织的烧烤。
  2008-11-6 今天离开公司，来告别。说通过了华为的面试，所以辞职，但后来华为又不要他了，说经验不足。
  2008-10-20 将离开公司，去华为。
  2008-7-31 来问基座程序中流水号的生成，似乎看程序的功力还需要锻炼。
  2008-5-7觉得特殊字符难以理解。
  2008-4-28 看了特殊字符的处理，说不难。
  2008-3-14 终于完成了12点阵到24点阵的转换。催着张悦玲写他的评定。

陈建星
  2008-11-24 拿万辉、梁剑的借款给他签字的时候问了一下沧州的情况。告诉他供电还不稳定。
  2008-7-23 说了两次让我出差，可是我还待在这里，估计他要不高兴了。
  2008-2-23 认为电信重组对空中充值是好消息，可以在多个电信企业中卖该产品。

田勇
  2008-11-21 据毛浩明说到敏讯去了，并带走了他带来的市场人员。
  2008-7-23 已经离开公司，据说是业绩不入人意。
  2008-2-21 发了邮件，分析电信重组的问题。

刘黎峰
  2008-8-6 在山东。年纪较大。北京集团招标时和张帆一起，同学中有许多在移动公司。喜欢和人抬杠。

袁世谦
  2008-12-1 指望今天就能拿到发票统计的程序。
  2008-11-24 问叫号器的情况。
  2008-11-21 昨天才拿到那个单独打印机的接口，当天就想把程序做出来。
  2008-9-17 老婆是大学教师，收入比他还要高。我们从沧州回来时，他老婆去接。说一般不在外面住，都是当天回。
  2008-9-8 中午请我们吃工作餐。说经济萧条。
  2008-9-6 说cz604所发生的错误是由于路由器配置的原因。
  2008-8-29 这几天在沧州处理收费终端的事情，希望继续改进：1、缴费结束后快一点结束缴费成功界面。其他好像无所谓了。
  2008-8-21 打了好几个电话，主要是说现在系统存在的问题。1、应缴话费总是显示0 2、套餐剩余分钟数查询错误。3、又出现了出门就冲正的情况。
  2008-8-6 昨天和万辉一起在营业厅，没有搞定远程桌面的问题，我催他和移动的联系，让万辉去改掉端口。
  2008-7-31 希望那个缴费失败改为缴费状态未知尽快改完。
  2008-7-29 当我说终端程序是梁剑现改的时候，他说：啊，又是一个测试版。
  2008-7-14 打电话来询问8201b锁小区时能否缴费的问题。王伍比较反感他，认为他过于胆小。主要是想改河北自助缴费服务端程序，他不怎么敢换。
  2008-5-5 由于存在缴费缴两次的问题，又到了沧州。
  2008-4-29 交钱失败的问题似乎已经没有了。但是出现了开机提升打印机缺纸的问题。
  2008-4-27 打电话来说有一台机器给他自己交钱每次都成功，而其他人则经常失败，很奇怪的问题。
  2008-3-7 打电话给我说要请我吃饭，此时我已经在火车站。
  2008-3-2 和办事处认为包了再搬机器不是一个好主意。
  2008-3-1 在办事处猛贴发票，并先把住宿的发票给了我。回头要把浙江大酒店的收据给他。
  2008-2-27 问我去不去廊坊，并开玩笑要把万辉拉去。
  2008-2-26 中午去吃饭时，和石家庄的文书走在了后面。推荐了浙江宾馆。 
  2008-2-25 很瘦，个字不高，住在离移动公司4-5站的地方。在我们调试服务器坐在地上的时候睡了。说和我们做同样产品的一家公司被省局发现在测试，责令不允许。

赖金花
  2008-11-25 问我要户口。

张帆
  2008-11-24 据顾克云所说，应该去了四川。
  2008-7-8 升为付总裁。
  2008-6-16 说话有一些急促。炒股赔了80万。希望有5000万然后退休。

江西贺总
  2008-11-20 江西新余移动市场部的老总。年纪不大。在交谈中主要想针对电信的市场进行攻击。

江西戴总
  2008-11-20 江西新余电信的付总。个子不高，是通则陈总的老乡。在我们和贺总聊的时候，来了一下，阐述了一下老乡。

韩丰
  2009-3-17 年前就离职了，原因未知。
  2008-11-25 今天打电话上来问是否还有毒气。
  2008-11-24 继续问招人的情况。说定万辉的票，如果晚一天走，其他消费还有多。
  2008-11-18 问这批考试人的情况。说c#的几乎没有人投简历。告诉他没有开发人员在郑州了。下面排毒的事情他投诉到市环保局。
  2008-11-3 人事部经理，但在解决楼上这里的毒气问题不能让李忠和彭广才满意。今天问我是否有人去郑州，他的身份证要办新的，想省快递费。

王晓蓉
  2008-11-6 似已辞职。
  2008-8-21 打电话给我，说让我到北京的事情。导致王伍对她非常不满意，认为跑腿都不跑。
  2008-6-18 通则北京办。只有一个人。不原意签单。曾经在新西兰。回到深圳后孩子不适应深圳的气候，经常生病，到了北京。老公有上市公司，资产在千万以上。

王郁
  2008-7-31 通则离职人员，曾经来聊过，说很佩服那个盛大的老总。后来给过一张名片，貌似是做墨盒销售去了。

李军
  2008-7-30 思特奇公司的项目经理，在河南的时候碰到过，当时他正在看股票。应该是汤鹏的上级。电话：15837133337 email：lijun@si-tech.com.cn

王昊翔
  2008-7-30 深圳奥拓电子有限公司自助设备事业部的总经理。曾经和齐辉等一起和他面谈河北沧州营业厅的排队机的开发问题。年纪稍大，有白发。

陈海荣
  2008-7-30 和黄川一起从其他公司跳来，曾经看过公司给她的收入证明超过10k。离职后曾经来过公司，现在似乎是夫妻一起买山寨机。

王春祺
  2008-7-31 华为公司无线终端测试与质量管理部软件测试工程师。曾经到过公司来抓trace。有点胖。

陈明江
  2008-4-25 在一个voip芯片的外资企业当技术支持。
  2008-3-3 原在通则公司工作，现已经离开。离开时王伍意见很大。

黄翔
  2008-7-24 这里还没有写协议，他就在折腾招标了，比较猛。让我去楼上找泰利了解情况，有点搞笑吧。

安玉民
  2008-3-14 发来了老外的摄像，当我告诉他要输入暗码时，说已经把文档给了老外。
  2008-3-13 马来西亚的老外打电话来问at指令的问题。叮嘱我只管技术问题。
  2008-3-12 问6954的问题。喜欢称人为帅哥。

李作丹
  2008-4-28 钥匙包掉进了厕所里，找管理处捞了起来。
  2008-3-17 认为领导总是对的，不对也对。
  2008-3-14 对老大们很有意见。
  2008-3-13 提出让他改东西，非常有气。说厂家的人曾经提出过很多意见，但陈就是不听，很累。
  2008-3-5 问我穿墙式的墙有多厚，我的回复有些生硬，不好。人家毕竟是老同志了。
  2008-3-3 打电话来问热敏纸的具体大小。邮箱总是自动回复的。

郑泽龙
  2008-3-24 升为江西办事处主任。
  2008-3-6 居然还认为我在搞那个统计。
  2008-3-4 通则公司某办事处。移动让统计农信通的情况，网站异常垃圾，指望着我给他搞统计。

孙军
  2008-4-10 曾经查过如何注册公司。现在比较忙，因为有台湾的订单，并要招2-3年经验的测试人员。

廖某
  2007-7-11 李忠通过同学介绍，做一个设备的网管，该设备是个二层交换，需要一个设备来做一个WEBSERVER。电话：13392782600

田江州
  2008-7-24 贵州业务支撑中心的。多问了几个问题，就说等到了招标后在说。

江某
  2008-7-14 中烟电子老总。和刘玲说：我也是混日子吧？


2018-11-13
m60a软件及测试参与人员：
张悦玲：话机程序。uboot, codec等调试。
余辉：wifi菜单，测试菜单完善，暗码完善，通讯录改读中兴数据库。
吴曦，汪光华，向杰：v3基础平台修正。
刘永辉：主要测试，bug提交者。
白俊剑：部分键盘程序，部分nv读取程序。
余小虎：客户对接。
...
我们主要讨论第2和第6个过程的工作：
我们希望第二个下程序工位下载的程序为基本通用程序，可以满足产线对产品的各项检查检测功能。比如不能锁机，锁卡，锁运营商等。并且希望，下载的这个基本程序已经包含我方的app等。这个基本程序由于tr069和网页部分改动较频繁，考虑由我方制作。这能否做到？如果可行要如何进行？

产线检查完成后，安装我们一直的做法，有一个下载配置的过程，配置文件指定客户定制的各种要求。这个过程很快，配置文件本身的正确性由中试部门检查过，产线只需检查配置文件是否生效即可。

我们看了“r1682 nv config tool ver:8.8.1”这个工具，能配置的选项很详细，基本考虑了运营商对话机电话方面的要求。由于这个产品带有wifi，所以运营商还会对默认ssid规则等信息进行指定。这个以前在ap测进行。所以我方也需要出一个配置文件，对ap侧的网页和tr069等行为进行配置。

当前按照我们的理解，“r1682 nv config tool ver:8.8.1”这个配置工具生成的配置文件，还是要使用downloader这个工具下载到话机中。能否有可能单独快速下载这个配置，其实文件很小的？加快生产过程。另外问一个下载这个配置后，话机是否有“应用配置”这样的过程？

其实我们希望两个配置文件可以在生产线看来，是一个文件，一个过程能够完成就最好，有没有什么建议？


技术特点:

voip: 实现低成本的语音通信, 为运营商大幅度节约成本.
volte: 实现高质量语音通话, 适配不同国家运营商环境
csfallback: 在无wolte网络时,自动回落到2g 3g网络.
sip alg: 挂接iad设备, voip无障碍使用.
fxo: slic实现普通电话机接入无线运营商网络.
multi apn, multi ssid: 实现用户分级接入
vpn: 实现pptp, l2tp, gre, ipsec安全接入
tr069: 实现运营商统一设备管理
snmp: 实现运营商统一设备管理

当前我方zte7520 产品1+1升级方案：

1 模块合作方修改了flash分区，告诉我方空间做了优化，去掉了recovery, recovery_kernel等分区。我方把了nv 中update_type=mifi_fota改为mifi_local。

2 需要进行升级时，合作方提供整体bin文件， 有30多m，我方使用downloader工具先做拆分，去掉其中ap侧的几个文件，ap_userdata.bin, ap_cpuap.bin, ap_securefs.bin，再使用downloader的多bin合一功能生成cp.bin。这个文件大约10m。

3 使用linux_plat/base/linux/user/zte_apps/goahead/cgi-src/upload.cgi.c这个程序编译出来的程序进行升级，我们的程序员大致看了这个程序，貌似是把文件写到某个地方。

4 进行ap侧升级，就是写ap文件系统， 写ap内核。重启。

5系统重启过程较普通启动较长，完全启动后即完全了全升级。
...
2018.2.10
苗立双     当前宽翼9x07, 9341 系列cpe维护, 
李柱栋     当前斯里兰卡电信fon项目, 较难. 后期摄像头
白俊剑     当前m60系列, 后期联芯9805  
梁剑       当前摄像头, 少量自助设备维护
郑达       当前摄像头, 部分工业路由器维护
任银善     当前p59工业路由器, 后期联芯9805
吴曦       当前中兴7520系列产品, 少量1860维护
汪光华     当前中兴7520系列产品, 少量1860维护, 少量g20话机维护
陈良       菲律宾支持
刘云       当前宽翼9x07, 部分南美项目支持. 部分p53工业路由器支持
姚国梁     当前海外9341系列cpe维护.
向杰       当前网页
周湘理     当前tr069, 网页. 和目摄像头跟进.
赵刚       当前ac, wifi转433. 
余小虎     斯里兰卡支持
...
郑达:
adc连接的是adc1但是从adc1上不能读到数据, 从adc0上读到数据, 和光敏数据正相关. 

2018.1.15
徐刚雄:
奥远的摄像头中路由器单板没有问题, 在55度时可以坚持1万个打流包. 但加上摄像头后最多的一次也只能到5000个. 再加上一个大的散热片试试吧.

金晶:
路由器和别人做桥接时, 使用ping的方式判断是否连通, 可能出现信号不好而重新搜索造成用户断网的情况, 不知道采用判断无线连接会不会好一点.

郑达:
摄像头很容易挂掉, 不需要10分钟.
看到一个错误, 在内核代码的/lib中一个 list_add

刘云 苗立双 韦邦根
拨号, 路由器等完成程度还需要看. 
今天demo板已经到了.
硬件上第一版就上全部的硬件, wifi switch slic. 要确定switch的接口方式.
网页的方案待定.
qmi是高通提供的api, 宽翼希望直接调用这些api, 而不是通过at指令的方式.
升级还不稳定, pcm还没有取到数据流.
...
汪光华 加入后期增加的at指令.
姚国梁 找到启动时发送at的地方.
何文秋 向杰 网页的样子已经改了, 要显示自己增加的参数, 变量.
郑荣俊 斯里兰卡的tr069, 内容不对, 还有ipv6的设置. 
当前工作:
nv中的参数定义有所改变, 要了解
斯里兰卡要改默认apn的参数
1g falsh的验证
